 ...
 */
final class Version20220905063418 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE sous_commande_produit');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sous_commande_produit (sous_commande_id INT NOT NULL, produit_id INT NOT NULL, INDEX IDX_9BD6C2B9C2D35D67 (sous_commande_id), INDEX IDX_9BD6C2B9F347EFB (produit_id), PRIMARY KEY(sous_commande_id, produit_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE sous_commande DROP FOREIGN KEY FK_66A4922882EA2E54');
